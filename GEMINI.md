...
| "Organizá la unidad N" (desde el PDF) | `/material` → `/apuntes/economia-empresarial/<unidad>` | `PLAN.md`, `apuntes/CONTEXT.md` |
...
El procedimiento detallado, unidad por unidad, está en **`PLAN.md`**. La idea es hacer
una unidad por vez, limpiando el contexto entre unidades. Resumen:
